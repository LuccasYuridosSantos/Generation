programa
{
	/*Descrição: ULTILIZANDO APENAS ESTRUTURA DE DECISÃO SIMPLES (SE, SENÃO E CASO) RESOLVA O PROBLEMA ABAIXO: 
	...
	*/
	funcao inicio()
	{
		...
		escreva("\nO funcionario de codigo ",c," Possui o salario total:R$ ", sal,"\nExcedente:R$ ", E)
